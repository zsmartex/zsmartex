...
type UserORM struct {
	...
	Uid         string     `gorm:"unique;index:idx_users_on_uid;serializer:uid" json:"uid,omitempty"`
	Otp         bool       `json:"otp,omitempty"`
	Role        string     `json:"role,omitempty"`
	State       string     `json:"state,omitempty"`
	Data        *UserData  `gorm:"type:jsonb" json:"data,omitempty"`
	UpdatedAt   *time.Time `json:"updated_at,omitempty"`
	Email       string     `gorm:"serializer:email" json:"email,omitempty"`
...
func DefaultApplyFieldMaskUser(ctx context.Context, patchee *User, patcher *User, updateMask *field_mask.FieldMask, prefix string, db *gorm.DB) (*User, error) {
	...
	for i, f := range updateMask.Paths {
		...
		if f == prefix+"ReferralUid" {
			patchee.ReferralUid = patcher.ReferralUid
			continue
		}
