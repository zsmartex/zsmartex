...
type UserCredentialsORM struct {
	ValueEncrypted null.String `json:"value_encrypted,omitempty"`
	Type           string      `json:"type,omitempty"`
	CreatedAt      *time.Time  `json:"created_at,omitempty"`
	UpdatedAt      *time.Time  `json:"updated_at,omitempty"`
	UserId         *int64      `gorm:"type:bigint;index:idx_users_on_user_id" json:"user_id,omitempty"`
	ValueIndex     null.Int64  `json:"value_index,omitempty"`
}
...
func (m *UserCredentials) ToORM(ctx context.Context) (UserCredentialsORM, error) {
	...
	err = to.ValueIndex.Scan(m.ValueIndex)
	if err != nil {
		return to, err
	}
	err = to.ValueEncrypted.Scan(m.ValueEncrypted)
	if err != nil {
		return to, err
	}
...
func (m *UserCredentialsORM) ToPB(ctx context.Context) (UserCredentials, error) {
	...
	to.ValueIndex = m.ValueIndex.Int64
	to.ValueEncrypted = m.ValueEncrypted.String
